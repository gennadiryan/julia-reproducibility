...
extern jl_mutex_t jl_deterministic_oid_lock; // builtins.c: eager deterministic objectid cache
...
static void init_global_mutexes(void) {
    ...
    JL_MUTEX_INIT(&jl_deterministic_oid_lock, "jl_deterministic_oid_lock");
}
